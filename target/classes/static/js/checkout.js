    ...
    !(function () {
                ...
                return function () {
                    ...
                    return e.every(function (n, e) {
                        ...
                        !(function () {
                            ...
                            s.dispatchEvent(Z("rzp_error", { detail: new Error("wrong " + e + "th argtype " + t[e]) }));
                    })
                        ? n.apply(null, t)
                        : t[0];
                };
        ...
        function H(n) {
            var e = (function a(o, r) {
                ...
                var u = null == r;
                return (
                    l.keys(o).forEach(function (n) {
                        var e,
                            t = o[n],
                            i = u ? n : r + "[" + n + "]";
                        "object" == typeof t
                            ? ((e = a(t, i)),
                              l.keys(e).forEach(function (n) {
                                  m[n] = e[n];
                              }))
                            : (m[i] = t);
                    }),
        ...
        var V,
            ...
            qn =
                ...
                g(mn)),
            Vn = (qn("none"), qn("block"), qn("inline-block"), T("offsetWidth")),
            Jn = T("offsetHeight"),
            Qn = E(An),
            ...
            ne =
                ...
                g(un)),
            ee = c.documentElement,
            te = c.body,
            ie = s.innerHeight,
            ae = s.pageYOffset,
            oe = s.scrollBy,
            re = s.scrollTo,
            me = s.requestAnimationFrame,
            ue = yn("querySelector", c),
            ce = yn("querySelectorAll", c);
        yn("getElementById", c), yn("getComputedStyle", s);
        function le(n, e, t, i) {
            var a, o, r, m, u, c;
            t && "get" === t.toLowerCase()
                ? ((n = U(n, e)), i ? s.open(n, i) : (s.location = n))
                : ((c = { action: n, method: t }), i && (c.target = i), (u = Tn("form")), (m = Yn(c)(u)), (r = Wn(se(e))(m)), (o = On(ee)(r)), (a = Hn(o)), In(a));
        }
        function se(n, t) {
            if (B(n)) {
                var i = "";
            ...
            call: function (e) {
                ...
                this.setReq("ajax", c),
                    ...
                    (c.onreadystatechange = function () {
                        ...
                        4 === c.readyState &&
                            c.status &&
                            ((n = Nn(c.responseText)) || ((n = O("Parsing error")).xhr = { status: c.status, text: c.responseText }),
                            n.error && s.dispatchEvent(Z("rzp_network_error", { detail: { method: r, url: o, baseUrl: o.split("?")[0], status: c.status, xhrErrored: !1, response: n } })),
                            e(n));
                    }),
                    (c.onerror = function () {
                        var n = be;
                        (n.xhr = { status: 0 }), s.dispatchEvent(Z("rzp_network_error", { detail: { method: r, url: o, baseUrl: o.split("?")[0], status: 0, xhrErrored: !0, response: n } })), e(n);
                    }),
                    (i = u),
                    (t = Mn("X-Razorpay-SessionId", he)(i)),
                    (n = Mn("X-Razorpay-TrackId", ve)(t)),
                    Pn(function (n, e) {
                        return c.setRequestHeader(e, n);
                    })(n),
                    c.send(m);
            },
        }).constructor = De).prototype = pe),
            (De.post = function (n) {
            ...
            (De.jsonp = function (u) {
                ...
                return (
                    ...
                    (n.call = function (e) {
                        ...
                        this.setReq("jsonp", a);
                        var o = U(u.url, u.data),
                            o = U(o, H({ callback: "Razorpay." + t })),
                            r = Tn("script"),
                            m = Ln({
                                src: o,
                                async: !0,
        ...
        function Oe() {
            var t,
                i = Fe(r(G() - 13885344e5) + Dn("000000" + F(1e6 * z()), -6)) + Fe(F(238328 * z())) + "0",
                a = 0,
                n = i;
            return (
                dn(function (n, e) {
        ...
        var $e = Oe(),
            Ie = { library: "checkoutjs", platform: "browser", referer: b.href };
        function He(n) {
        ...
        var Ue,
            ...
            qe = function () {
                var n, e, t, i;
                if (Ze.length) {
                    var a = Sn(y, "sendBeacon"),
                        o = { context: Ue, addons: [{ name: "ua_parser", input_key: "user_agent", output_key: "user_agent_parsed" }], events: Ze.splice(0, Ze.length) },
                        r = { url: "https://lumberjack.razorpay.com/v1/track", data: { key: "ZmY5N2M0YzVkN2JiYzkyMWM1ZmVmYWJk", data: ((i = Kn(o)), (t = h(i)), (e = p(t)), (n = v(e)), h(n)) } };
                    try {
                ...
                ? r.isLiveMode() &&
                  a(function () {
                      ...
                      (i.external_wallets =
                          ...
                          $e && (a.local_order_id = $e),
                          (a.build_number = 10374),
                          (a.experiments = (function () {
                              try {
                                  var n = Ee.getItem(xe),
                                      e = Nn(n);
                              } catch (n) {}
                          ...
                          je({ event: m, properties: a, timestamp: G() }),
                          We(e),
                          c && qe();
                  })
                : Ye.push([m, u, c]);
        ...
        (Ve.dispatchPendingEvents = function (n) {
            ...
            n &&
                ((e = Ve.bind(Ve, n)),
                Ye.splice(0, Ye.length).forEach(function (n) {
                    e.apply(Ve, n);
                }));
        }),
            ...
            et = {
                ...
                track: function (n, e) {
                    ...
                    (t = j(r || {})),
                        ...
                        (r = B((r = t)) ? j(r) : { data: r }).meta && B(r.meta) && (s = Ln(s, r.meta)),
                        (r.meta = s),
                        a && (n = a + ":" + n),
                        Ve(u, n, r, l);
                },
        ...
        var mt = ot(/iPhone/),
            ...
            ct =
                ...
                ot(/Linux/),
                ot(/Mac OS/),
                ot(/^((?!chrome|android).)*safari/i) || rt(/Apple/),
                ot(/firefox/),
                ot(/Chrome/) && rt(/Google Inc/),
                ot(/; wv\) |Gecko\) Version\/[^ ]+ Chrome/),
                ot(/Instagram/)),
            lt = ot(/FB_IAB\/FB4A/),
            st = ot(/FBAN\/FBIOS/),
            dt = lt || st;
        ...
        function pt(n, e, t, i) {
            var a = e[(t = t.toLowerCase())],
                o = typeof a;
            "object" == o && null === a
                ? P(i) && ("true" === i || "1" === i ? (i = !0) : ("false" !== i && "0" !== i) || (i = !1))
                : "string" == o && (w(i) || M(i))
                ? (i = r(i))
                : "number" == o
                ? (i = m(i))
                : "boolean" == o && (P(i) ? ("true" === i || "1" === i ? (i = !0) : ("false" !== i && "0" !== i) || (i = !1)) : w(i) && (i = !!i)),
        ...
        function gt(t) {
            Pn(vt, function (n, t) {
                ...
                (t = yt(t, vt)).callback_url && ft && (t.redirect = !0),
                (this.get = function (n) {
        ...
        var Dt,
            ...
            Mt = s.screen;
        try {
            (Rt = [y.userAgent, y.language, new u().getTimezoneOffset(), y.platform, y.cpuClass, y.hardwareConcurrency, Mt.colorDepth, y.deviceMemory, Mt.width + Mt.height, Mt.width * Mt.height, s.devicePixelRatio]),
                (Dt = Rt.join()),
                (St = new s.TextEncoder("utf-8").encode(Dt)),
                (kt = void s.crypto.subtle.digest("SHA-1", St).then(function (n) {
        ...
        var Bt,
            ...
            Tt = {},
            Ct = {
                AED: { code: "784", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "د.إ", name: "Emirati Dirham" },
                ALL: { code: "008", denomination: 100, min_value: 221, min_auth_value: 100, symbol: "Lek", name: "Albanian Lek" },
                AMD: { code: "051", denomination: 100, min_value: 975, min_auth_value: 100, symbol: "֏", name: "Armenian Dram" },
                ARS: { code: "032", denomination: 100, min_value: 80, min_auth_value: 100, symbol: "ARS", name: "Argentine Peso" },
                AUD: { code: "036", denomination: 100, min_value: 50, min_auth_value: 100, symbol: "A$", name: "Australian Dollar" },
                AWG: { code: "533", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "Afl.", name: "Aruban or Dutch Guilder" },
                BBD: { code: "052", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "Bds$", name: "Barbadian or Bajan Dollar" },
                BDT: { code: "050", denomination: 100, min_value: 168, min_auth_value: 100, symbol: "৳", name: "Bangladeshi Taka" },
                BMD: { code: "060", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "$", name: "Bermudian Dollar" },
                BND: { code: "096", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "BND", name: "Bruneian Dollar" },
                BOB: { code: "068", denomination: 100, min_value: 14, min_auth_value: 100, symbol: "Bs", name: "Bolivian Bolíviano" },
                BSD: { code: "044", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "BSD", name: "Bahamian Dollar" },
                BWP: { code: "072", denomination: 100, min_value: 22, min_auth_value: 100, symbol: "P", name: "Botswana Pula" },
                BZD: { code: "084", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "BZ$", name: "Belizean Dollar" },
                CAD: { code: "124", denomination: 100, min_value: 50, min_auth_value: 100, symbol: "C$", name: "Canadian Dollar" },
                CHF: { code: "756", denomination: 100, min_value: 50, min_auth_value: 100, symbol: "CHf", name: "Swiss Franc" },
                CNY: { code: "156", denomination: 100, min_value: 14, min_auth_value: 100, symbol: "¥", name: "Chinese Yuan Renminbi" },
                COP: { code: "170", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "COL$", name: "Colombian Peso" },
                CRC: { code: "188", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "₡", name: "Costa Rican Colon" },
                CUP: { code: "192", denomination: 100, min_value: 53, min_auth_value: 100, symbol: "$MN", name: "Cuban Peso" },
                CZK: { code: "203", denomination: 100, min_value: 46, min_auth_value: 100, symbol: "Kč", name: "Czech Koruna" },
                DKK: { code: "208", denomination: 100, min_value: 250, min_auth_value: 100, symbol: "DKK", name: "Danish Krone" },
                DOP: { code: "214", denomination: 100, min_value: 102, min_auth_value: 100, symbol: "RD$", name: "Dominican Peso" },
                DZD: { code: "012", denomination: 100, min_value: 239, min_auth_value: 100, symbol: "د.ج", name: "Algerian Dinar" },
                EGP: { code: "818", denomination: 100, min_value: 35, min_auth_value: 100, symbol: "E£", name: "Egyptian Pound" },
                ETB: { code: "230", denomination: 100, min_value: 57, min_auth_value: 100, symbol: "ብር", name: "Ethiopian Birr" },
                EUR: { code: "978", denomination: 100, min_value: 50, min_auth_value: 100, symbol: "€", name: "Euro" },
                FJD: { code: "242", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "FJ$", name: "Fijian Dollar" },
                GBP: { code: "826", denomination: 100, min_value: 30, min_auth_value: 100, symbol: "£", name: "British Pound" },
                GIP: { code: "292", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "GIP", name: "Gibraltar Pound" },
                GMD: { code: "270", denomination: 100, min_value: 100, min_auth_value: 100, symbol: "D", name: "Gambian Dalasi" },
                GTQ: { code: "320", denomination: 100, min_value: 16, min_auth_value: 100, symbol: "Q", name: "Guatemalan Quetzal" },
                GYD: { code: "328", denomination: 100, min_value: 418, min_auth_value: 100, symbol: "G$", name: "Guyanese Dollar" },
                HKD: { code: "344", denomination: 100, min_value: 400, min_auth_value: 100, symbol: "HK$", name: "Hong Kong Dollar" },
                HNL: { code: "340", denomination: 100, min_value: 49, min_auth_value: 100, symbol: "HNL", name: "Honduran Lempira" },
                HRK: { code: "191", denomination: 100, min_value: 14, min_auth_value: 100, symbol: "kn", name: "Croatian Kuna" },
                HTG: { code: "332", denomination: 100, min_value: 167, min_auth_value: 100, symbol: "G", name: "Haitian Gourde" },
                HUF: { code: "348", denomination: 100, min_value: 555, min_auth_value: 100, symbol: "Ft", name: "Hungarian Forint" },
                IDR: { code: "360", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "Rp", name: "Indonesian Rupiah" },
                ILS: { code: "376", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "₪", name: "Israeli Shekel" },
                INR: { code: "356", denomination: 100, min_value: 100, min_auth_value: 100, symbol: "₹", name: "Indian Rupee" },
                JMD: { code: "388", denomination: 100, min_value: 250, min_auth_value: 100, symbol: "J$", name: "Jamaican Dollar" },
                KES: { code: "404", denomination: 100, min_value: 201, min_auth_value: 100, symbol: "Ksh", name: "Kenyan Shilling" },
                KGS: { code: "417", denomination: 100, min_value: 140, min_auth_value: 100, symbol: "Лв", name: "Kyrgyzstani Som" },
                KHR: { code: "116", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "៛", name: "Cambodian Riel" },
                KYD: { code: "136", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "CI$", name: "Caymanian Dollar" },
                KZT: { code: "398", denomination: 100, min_value: 759, min_auth_value: 100, symbol: "₸", name: "Kazakhstani Tenge" },
                LAK: { code: "418", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "₭", name: "Lao Kip" },
                LBP: { code: "422", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "&#1604;.&#1604;.", name: "Lebanese Pound" },
                LKR: { code: "144", denomination: 100, min_value: 358, min_auth_value: 100, symbol: "රු", name: "Sri Lankan Rupee" },
                LRD: { code: "430", denomination: 100, min_value: 325, min_auth_value: 100, symbol: "L$", name: "Liberian Dollar" },
                LSL: { code: "426", denomination: 100, min_value: 29, min_auth_value: 100, symbol: "LSL", name: "Basotho Loti" },
                MAD: { code: "504", denomination: 100, min_value: 20, min_auth_value: 100, symbol: "د.م.", name: "Moroccan Dirham" },
                MDL: { code: "498", denomination: 100, min_value: 35, min_auth_value: 100, symbol: "MDL", name: "Moldovan Leu" },
                MKD: { code: "807", denomination: 100, min_value: 109, min_auth_value: 100, symbol: "ден", name: "Macedonian Denar" },
                MMK: { code: "104", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "MMK", name: "Burmese Kyat" },
                MNT: { code: "496", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "₮", name: "Mongolian Tughrik" },
                MOP: { code: "446", denomination: 100, min_value: 17, min_auth_value: 100, symbol: "MOP$", name: "Macau Pataca" },
                MUR: { code: "480", denomination: 100, min_value: 70, min_auth_value: 100, symbol: "₨", name: "Mauritian Rupee" },
                MVR: { code: "462", denomination: 100, min_value: 31, min_auth_value: 100, symbol: "Rf", name: "Maldivian Rufiyaa" },
                MWK: { code: "454", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "MK", name: "Malawian Kwacha" },
                MXN: { code: "484", denomination: 100, min_value: 39, min_auth_value: 100, symbol: "Mex$", name: "Mexican Peso" },
                MYR: { code: "458", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "RM", name: "Malaysian Ringgit" },
                NAD: { code: "516", denomination: 100, min_value: 29, min_auth_value: 100, symbol: "N$", name: "Namibian Dollar" },
                NGN: { code: "566", denomination: 100, min_value: 723, min_auth_value: 100, symbol: "₦", name: "Nigerian Naira" },
                NIO: { code: "558", denomination: 100, min_value: 66, min_auth_value: 100, symbol: "NIO", name: "Nicaraguan Cordoba" },
                NOK: { code: "578", denomination: 100, min_value: 300, min_auth_value: 100, symbol: "NOK", name: "Norwegian Krone" },
                NPR: { code: "524", denomination: 100, min_value: 221, min_auth_value: 100, symbol: "रू", name: "Nepalese Rupee" },
                NZD: { code: "554", denomination: 100, min_value: 50, min_auth_value: 100, symbol: "NZ$", name: "New Zealand Dollar" },
                PEN: { code: "604", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "S/", name: "Peruvian Sol" },
                PGK: { code: "598", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "PGK", name: "Papua New Guinean Kina" },
                PHP: { code: "608", denomination: 100, min_value: 106, min_auth_value: 100, symbol: "₱", name: "Philippine Peso" },
                PKR: { code: "586", denomination: 100, min_value: 227, min_auth_value: 100, symbol: "₨", name: "Pakistani Rupee" },
                QAR: { code: "634", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "QR", name: "Qatari Riyal" },
                RUB: { code: "643", denomination: 100, min_value: 130, min_auth_value: 100, symbol: "₽", name: "Russian Ruble" },
                SAR: { code: "682", denomination: 100, min_value: 10, min_auth_value: 100, symbol: "SR", name: "Saudi Arabian Riyal" },
                SCR: { code: "690", denomination: 100, min_value: 28, min_auth_value: 100, symbol: "SRe", name: "Seychellois Rupee" },
                SEK: { code: "752", denomination: 100, min_value: 300, min_auth_value: 100, symbol: "SEK", name: "Swedish Krona" },
                SGD: { code: "702", denomination: 100, min_value: 50, min_auth_value: 100, symbol: "S$", name: "Singapore Dollar" },
                SLL: { code: "694", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "Le", name: "Sierra Leonean Leone" },
                SOS: { code: "706", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "Sh.so.", name: "Somali Shilling" },
                SSP: { code: "728", denomination: 100, min_value: 100, min_auth_value: 100, symbol: "SS£", name: "South Sudanese Pound" },
                SVC: { code: "222", denomination: 100, min_value: 18, min_auth_value: 100, symbol: "₡", name: "Salvadoran Colon" },
                SZL: { code: "748", denomination: 100, min_value: 29, min_auth_value: 100, symbol: "E", name: "Swazi Lilangeni" },
                THB: { code: "764", denomination: 100, min_value: 64, min_auth_value: 100, symbol: "฿", name: "Thai Baht" },
                TTD: { code: "780", denomination: 100, min_value: 14, min_auth_value: 100, symbol: "TT$", name: "Trinidadian Dollar" },
                TZS: { code: "834", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "Sh", name: "Tanzanian Shilling" },
                USD: { code: "840", denomination: 100, min_value: 50, min_auth_value: 100, symbol: "$", name: "US Dollar" },
                UYU: { code: "858", denomination: 100, min_value: 67, min_auth_value: 100, symbol: "$U", name: "Uruguayan Peso" },
                UZS: { code: "860", denomination: 100, min_value: 1e3, min_auth_value: 100, symbol: "so'm", name: "Uzbekistani Som" },
                YER: { code: "886", denomination: 100, min_value: 501, min_auth_value: 100, symbol: "﷼", name: "Yemeni Rial" },
                ZAR: { code: "710", denomination: 100, min_value: 29, min_auth_value: 100, symbol: "R", name: "South African Rand" },
            },
            Et = {
                three: function (n, e) {
        ...
        (Ut.postInit = _n),
            (Ut.onNew = function (n, e) {
                var t = this;
                "ready" === n &&
                    (this.prefs
                        ? e(n, this.prefs)
                        : Zt(Yt(this), function (n) {
        ...
        Ht.payment = {
            ...
            getPrefs: function (e, t) {
                ...
                return (
                    et.track("prefs:start", { type: "metric" }),
                    B(e) && (e["_[request_index]"] = et.updateRequestIndex("preferences")),
                    De({
                        url: U($t("preferences"), e),
                        callback: function (n) {
                            if ((et.track("prefs:end", { type: "metric", data: { time: a() } }), n.xhr && 0 === n.xhr.status)) return Zt(e, t);
                            t(n);
                        },
                    })
                );
        ...
        function Yt(n) {
            if (n) {
                ...
                return (
                    o && ("" + r).length && a.push(o),
                    (i.currency = a),
                    dn(["order_id", "customer_id", "invoice_id", "payment_link_id", "subscription_id", "auth_link_id", "recurring", "subscription_card_change", "account_id", "contact_id", "checkout_config_id", "amount"], function (n) {
                        var e = t(n);
                        e && (i[n] = e);
                    }),
                    (i["_[build]"] = 10374),
                    (i["_[checkout_id]"] = n.id),
                    (i["_[library]"] = Ve.props.library),
                    (i["_[platform]"] = Ve.props.platform),
                    i
                );
            }
        }
        ...
        var jt = {
            ...
            amount: function (n, e) {
                var t,
                    ...
                    r = o.minimum,
                    m = "";
                if ((o.decimals && o.minor ? (m = " " + o.minor) : o.major && (m = " " + o.major), void 0 === (i = r) && (i = 100), (/[^0-9]/.test((t = n)) || !(i <= (t = f(t, 10)))) && !e.recurring))
                    return "should be passed in integer" + m + ". Minimum value is " + r + m + ", i.e. " + Ot(r, a);
            },
            currency: function (n) {
        ...
        (Ht.configure = function (n) {
            ...
            (vt.partnership_logo = ""),
            (vt.nativeotp = !0),
            (vt.remember_customer = !1),
            (vt.personalization = !1),
            (vt.paused = !1),
            (vt.fee_label = ""),
            (vt.min_amount_label = ""),
            (vt.partial_payment = { min_amount_label: "", full_amount_label: "", partial_amount_label: "", partial_amount_description: "", select_partial: !1 }),
            (vt.method = { netbanking: null, card: !0, credit_card: !0, debit_card: !0, cardless_emi: null, wallet: null, emi: !0, upi: null, upi_intent: !0, qr: !0, bank_transfer: !0, upi_otm: !0 }),
            (vt.prefill = {
                amount: "",
                wallet: "",
                provider: "",
            ...
            (vt.features = { cardsaving: !0 }),
            (vt.readonly = { contact: !1, email: !1, name: !1 }),
            (vt.hidden = { contact: !1, email: !1 }),
            (vt.modal = { confirm_close: !1, ondismiss: _n, onhidden: _n, escape: !0, animation: !s.matchMedia("(prefers-reduced-motion: reduce)").matches, backdropclose: !1, handleback: !0 }),
            (vt.external = { wallets: [], handler: _n }),
            (vt.theme = { upi_only: !1, color: "", backdrop_color: "rgba(0,0,0,0.6)", image_padding: !0, image_frame: !0, close_button: !0, close_method_back: !1, hide_topbar: !1, branding: "", debit_card: !1 }),
            (vt._ = { integration: null, integration_version: null, integration_parent_version: null }),
            (vt.config = { display: {} });
        var Wt,
            qt,
            Vt,
        ...
        ai.prototype = {
                ...
                return (
                    this.el ||
                        ((t = {
                            ...
                            src: ((i = n), (o = wt.frame), (r = z() < 0.05), o || ((o = $t("checkout")), (a = Yt(i)) ? (o = U(o, a)) : ((o += "/public"), r && (o += "/canary"))), r && (o = U(o, { canary: 1 })), o),
                            class: "razorpay-checkout-frame",
                        }),
                        (this.el = ((e = Tn("iframe")), Yn(t)(e)))),
                    this.el
                );
            },
            openRzp: function (n) {
                var e,
                    ...
                    a,
                    o,
                    r = ((e = this.el), jn({ width: "100%", height: "100%" })(e)),
                    m = n.get("parent"),
                ...
                !(function (n, e) {
                    ...
                    n !== this.rzp && (Cn(r) !== u && ((t = u), $n(r)(t)), (this.rzp = n)),
                    m
                        ? ((i = r), Zn("minHeight", "530px")(i), (this.embedded = !0))
                        : ((a = u), (o = Zn("display", "block")(a)), Vn(o), ii(n.get("theme.backdrop_color")), /^rzp_t/.test(n.get("key")) && ai.ribbon && (ai.ribbon.style.opacity = 1), this.setMetaAndOverflow()),
                    this.bind(),
                    this.onload();
            },
            makeMessage: function () {
                ...
                return (
                    ...
                    Pn(n.modal.options, function (n, e) {
                        t["modal." + e] = n;
                    }),
            ...
            close: function () {
                ii(""),
                    ai.ribbon && (ai.ribbon.style.opacity = 0),
                    (function (n) {
                        n && dn(n, In);
                        var e = ti();
                        e && dn(e, On(qt));
                    })(this.$metas),
                    (Vt.overflow = ei.overflow),
                    this.unbind(),
                    ni && Xt(0, ei.oldY),
                    Ve.flush();
            },
            bind: function () {
                ...
                this.listeners ||
                    ((this.listeners = []),
                    (n = {}),
                    ni && ((n.orientationchange = ei.orientationchange), this.rzp.get("parent") || (n.resize = ei.resize)),
                    Pn(n, function (n, e) {
                        var t;
            ...
            setMetaAndOverflow: function () {
                ...
                qt &&
                    ...
                    (this.$metas = [
                        ((n = Tn("meta")), Yn({ name: "viewport", content: "width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" })(n)),
                        ((e = Tn("meta")), Yn({ name: "theme-color", content: this.rzp.get("theme.color") })(e)),
                    ]),
                    dn(this.$metas, On(qt)),
                    (ei.overflow = Vt.overflow),
                    (Vt.overflow = "hidden"),
                    ni && ((ei.oldY = s.pageYOffset), s.scrollTo(0, 0), ei.orientationchange.call(this)));
            },
            ...
            onmessage: function (n) {
                ...
                i &&
                    ((e = i.event),
                    (t = this.rzp),
                    n.origin && "frame" === i.source && n.source === this.el.contentWindow && ((i = i.data), this["on" + e](i), ("dismiss" !== e && "fault" !== e) || et.track(e, { data: i, r: t, immediately: !0 })));
            },
            onload: function () {
            ...
            onsubmit: function (e) {
                ...
                var t = this.rzp;
                "wallet" === e.method &&
                    dn(t.get("external.wallets"), function (n) {
                        if (n === e.wallet)
                            try {
            ...
            oncomplete: function (n) {
                ...
                var e = this.rzp,
                    t = e.get("handler");
                et.track("checkout_success", { r: e, data: n, immediately: !0 }),
                    K(t) &&
                        a(function () {
                            t.call(e, n);
                        }, 200);
        ...
        var ui,
            ci = c.currentScript || (ui = ce("script"))[ui.length - 1];
        function li(n) {
            var e,
                t = Cn(ci),
                i = $n(((e = Tn()), Wn(se(n))(e)))(t),
                a = kn("onsubmit", _n)(i);
            Hn(a);
        }
        function si(m) {
            var n,
                e = Cn(ci),
                t = $n(((n = Tn("input")), Ln({ type: "submit", value: m.get("buttontext"), className: "razorpay-payment-button" })(n)))(e);
        ...
        function hi() {
            ...
            return (
                di ||
                    ((n = Tn()),
                    (e = kn("className", "razorpay-container")(n)),
                    (t = kn("innerHTML", "<style>@keyframes rzp-rot{to{transform: rotate(360deg);}}@-webkit-keyframes rzp-rot{to{-webkit-transform: rotate(360deg);}}</style>")(e)),
                    (i = jn({ zIndex: 1e9, position: "fixed", top: 0, display: "none", left: 0, height: "100%", width: "100%", "-webkit-overflow-scrolling": "touch", "-webkit-backface-visibility": "hidden", "overflow-y": "visible" })(t)),
                    (di = On(oi)(i)),
                    (d = ai.container = di),
                    (v = Tn()),
                    (h = kn("className", "razorpay-backdrop")(v)),
                    (f = jn({ "min-height": "100%", transition: "0.3s ease-out", position: "fixed", top: 0, left: 0, width: "100%", height: "100%" })(h)),
                    (a = On(d)(f)),
                    (r = ai.backdrop = a),
                    (l = "rotate(45deg)"),
                    (s = "opacity 0.3s ease-in"),
                    (c = Tn("span")),
                    (u = kn("innerHTML", "Test Mode")(c)),
                    (m = jn({
        ...
        (ri.onNew = function (n, e) {
            ...
            (ri.open = mi(function () {
                ...
                return (
                    Ve(this, "open"),
                    n.el.contentWindow || (n.close(), n.afterClose(), s.alert("This browser is not supported.\nPlease try payment in another browser.")),
                    "-new.js" === ci.src.slice(-7) && Ve(this, "oldscript", b.href),
                    this
                );
            })),
                ...
                !(function () {
                    ...
                    Pn(ci.attributes, function (n) {
                        ...
                        /^data-/.test(i) &&
                            ((e = a),
                            (i = i.replace(/^data-/, "")),
                            "true" === (t = n.value) ? (t = !0) : "false" === t && (t = !1),
        ...
        s.addEventListener("rzp_error", function (n) {
            ...
            s.addEventListener("rzp_network_error", function (n) {
                var e = n.detail;
                (e && "https://lumberjack.razorpay.com/v1/track" === e.baseUrl) || et.track("network_error", { data: e, immediately: !0 });
            }),
            (Ve.props.library = "checkoutjs"),
            (vt.handler = function (n) {
                var e;
                !x(this, Ht) || ((e = this.get("callback_url")) && le(e, n, "post"));
            }),
            (vt.buttontext = "Pay Now"),
            (vt.parent = null),
            (jt.parent = function (n) {
